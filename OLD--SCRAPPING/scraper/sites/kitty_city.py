#!/usr/bin/env python3
"""
kitty-city.tn scraper — WooCommerce (httpx).
...
BASE = "https://kitty-city.tn"


class KittyCityScraper(FastScraper):

    def __init__(self, logger: logging.Logger):
        super().__init__("kitty-city", logger)
...
def get_scraper(logger: logging.Logger) -> KittyCityScraper:
    return KittyCityScraper(logger)
