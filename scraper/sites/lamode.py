...
class LamodeScraper(FastScraper):
    ...
    def __init__(self, logger: logging.Logger):
        ...
        self._browser = None
        self._ctx = None
        # Allow up to 2 concurrent Playwright contexts. Higher numbers caused
        # frequent TargetClosedError / ERR_ABORTED when 8+ workers each tried
        # to spin up their own contexts simultaneously.
        self._fetch_lock = asyncio.Semaphore(2)
