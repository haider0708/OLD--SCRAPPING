...
AVAILABLE_SCRAPERS = {
    ...
    "tunisiatech": "scraper.sites.tunisiatech",
    "dokena": "scraper.sites.dokena",
    "noonclo": "scraper.sites.noonclo",
    "peaksports": "scraper.sites.peaksports",
    "watchestunisia": "scraper.sites.watchestunisia",
    ...
    "electrosifi": "scraper.sites.electrosifi",
    "exist": "scraper.sites.exist",
    "celio": "scraper.sites.celio",
    "mabrouk": "scraper.sites.mabrouk",
    "praga": "scraper.sites.praga",
    "originalwatchtunisie": "scraper.sites.originalwatchtunisie",
    "castratime": "scraper.sites.castratime",
    "opticboxedge": "scraper.sites.opticboxedge",
    ...
    "nablielectrosat": "scraper.sites.nablielectrosat",
    "twenty": "scraper.sites.twenty",
    "lofficielshop": "scraper.sites.lofficielshop",
    "shopingo": "scraper.sites.shopingo",
    "zen": "scraper.sites.zen",
    "hamadiabid": "scraper.sites.hamadiabid",
    "sasio": "scraper.sites.sasio",
    "mykenza": "scraper.sites.mykenza",
    "techno-watch": "scraper.sites.techno_watch",
    "kotonhouse": "scraper.sites.kotonhouse",
    "infinity": "scraper.sites.infinity",
    ...
    "zara": "scraper.sites.zara",
    "pullandbear": "scraper.sites.pullandbear",
    "bershka": "scraper.sites.bershka",
}
