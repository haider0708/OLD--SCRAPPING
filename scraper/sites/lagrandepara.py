#!/usr/bin/env python3
"""
lagrandepara.tn scraper — Shopify (httpx).
...
BASE = "https://lagrandepara.tn"


class LagrandeparaScraper(FastScraper):

    def __init__(self, logger: logging.Logger):
        super().__init__("lagrandepara", logger)
...
def get_scraper(logger: logging.Logger) -> LagrandeparaScraper:
    return LagrandeparaScraper(logger)
